...
Scene* aggressive_magician::createScene() {
...
bool aggressive_magician::init() {
    ...
    auto picture = Sprite::create("images/manual/aggressive_magician.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/aggressive_magician.png'");
    } else {
