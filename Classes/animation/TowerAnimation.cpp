...
void Bullet::explosion() {
    ...
    if (this->levelScene->getEnemy(this->enemy->id) == nullptr) {
    ...
    if (this->isScaling) {
        ...
        auto *animation =
                cocos2d::Animation::createWithSpriteFrames(frames, 0.05f);
        ...
        if (particle) {
            particle->setPosition(enemySprite->getPositionX(),
                                  enemySprite->getPositionY());
        }
...
MagicBullet::MagicBullet(LevelScene *levelScene,
                         ...
                         towerdefence::core::Enemy *enemy) : Bullet(levelScene, tower, enemy) {
...
void MagicBullet::explosion() {
    ...
    auto *enemySprite = this->levelScene->getEnemy(this->enemy->id);
    this->bullet->setPosition(enemySprite->getPositionX(),
                              enemySprite->getPositionY());
    cocos2d::Vector<cocos2d::SpriteFrame *> frames;
