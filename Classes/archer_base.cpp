...
bool archer_base::init() {
    ...
    auto picture = Sprite::create("images/manual/archer_base.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/archer_base.png'");
    } else {
