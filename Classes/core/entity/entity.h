...
// Uniquely indentify a buff.
        ...
        struct ExtraStorage {
            ...
            template<class T>
            T get_storage(const std::string &key) const {
            ...
            // set storage of key
            template<class T>
            void set_storage(const std::string &key, T value) {
...
// used in CallbackTimer
        ...
        template<class T>
        struct EnemyFactory final : EnemyFactoryBase {
            route::Route route;
        ...
        template<class T>
        struct TowerFactory : TowerFactoryBase {
        ...
        template<class T>
        TowerInfo TowerFactory<T>::info() const { return T::INFO; }
