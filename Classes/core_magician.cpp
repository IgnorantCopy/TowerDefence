...
Scene* core_magician::createScene() {
...
bool core_magician::init() {
    ...
    auto picture = Sprite::create("images/manual/core_magician.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/core_magician.png'");
    } else {
