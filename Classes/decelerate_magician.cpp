...
Scene* decelerate_magician::createScene() {
...
bool decelerate_magician::init() {
    ...
    auto picture = Sprite::create("images/manual/decelerate_magician.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/decelerate_magician.png'");
    } else {
