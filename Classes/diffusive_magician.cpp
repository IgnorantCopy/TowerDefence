...
Scene* diffusive_magician::createScene() {
...
bool diffusive_magician::init() {
    ...
    auto picture = Sprite::create("images/manual/diffusive_magician.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/diffusive_magician.png'");
    } else {
