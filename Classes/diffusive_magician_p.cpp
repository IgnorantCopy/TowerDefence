...
Scene* diffusive_magician_p::createScene() {
...
bool diffusive_magician_p::init() {
    if(!Scene::init())
        return false;
    ...
    auto picture = Sprite::create("images/manual/diffusive_magician_p.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/diffusive_magician_p.png'");
    } else {
