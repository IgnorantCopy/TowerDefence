...
bool helper_base::init() {
    ...
    auto picture = Sprite::create("images/manual/helper_base.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/helper_base.png'");
    } else {
