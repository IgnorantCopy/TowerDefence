...
Scene* highspeed_archor::createScene() {
...
bool highspeed_archor::init() {
    ...
    auto picture = Sprite::create("images/manual/highspeed_archor.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/highspeed_archor.png'");
    } else {
