...
Scene* magician_base::createScene() {
...
bool magician_base::init() {
    ...
    auto picture = Sprite::create("images/manual/magician_base.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/magician_base.png'");
    } else {
