...
Scene* special_magician::createScene() {
...
bool special_magician::init() {
    ...
    auto picture = Sprite::create("images/manual/special_magician.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/special_magician.png'");
    } else {
