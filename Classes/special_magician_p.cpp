...
Scene* special_magician_p::createScene() {
...
bool special_magician_p::init() {
    ...
    auto picture = Sprite::create("images/manual/special_magician_p.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/special_magician_p.png'");
    } else {
