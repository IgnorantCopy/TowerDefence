...
Scene* weaken_magician::createScene() {
...
bool weaken_magician::init() {
    ...
    auto picture = Sprite::create("images/manual/weaken_magician.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/weaken_magician.png'");
    } else {
