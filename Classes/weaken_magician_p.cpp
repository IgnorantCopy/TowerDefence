...
Scene* weaken_magician_p::createScene() {
...
bool weaken_magician_p::init() {
    ...
    auto picture = Sprite::create("images/manual/weaken_magician_p.png", Rect(0, 0, 2500, 1500));
    if (picture == nullptr) {
        problemLoading("'images/manual/weaken_magician_p.png'");
    } else {
